...
// Contrast-circle glyph — the conventional "appearance / theme" mark.
  ...
  return (
    <div className={styles.wrap} data-tour="settings-panel">
      ...
      <section className={styles.appearancePanel}>
        <div className={styles.appearanceIcon} aria-hidden="true">
          <AppearanceIcon />
        </div>
        <div className={styles.tutorialCopy}>
          <span className={styles.kicker}>Appearance</span>
          <h3>Theme</h3>
          <p>Match Axiony to your system, or lock it to light or dark. Saved to this browser.</p>
        </div>
        <ThemeToggle className={styles.appearanceControl} />
      </section>
