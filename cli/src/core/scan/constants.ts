...
export const PAGE_READINESS_STABLE_WINDOW = 800;

export const PAGE_READINESS_MIN_TEXT_LENGTH = 20;

export const PAGE_READINESS_MIN_INTERACTIVE_ELEMENTS = 1;

export const PAGE_CHALLENGE_RETRY_TIMEOUT = 15_000;

export const PAGE_CHALLENGE_RETRY_DELAY = 1_000;

export const PAGE_CHALLENGE_RETRY_ATTEMPTS = 3;
